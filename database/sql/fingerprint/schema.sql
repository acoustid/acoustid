...
CREATE INDEX fingerprint_idx_updated ON fingerprint (updated) WHERE updated IS NOT NULL;
...
CREATE INDEX track_idx_gid ON track (gid);
CREATE INDEX track_idx_new_id ON track (new_id) WHERE (new_id IS NOT NULL);
CREATE INDEX track_idx_created ON track (created);
CREATE INDEX track_idx_updated ON track (updated) WHERE updated IS NOT NULL;
...
CREATE INDEX track_puid_idx_created ON track_puid (created);
CREATE INDEX track_puid_idx_updated ON track_puid (updated) WHERE updated IS NOT NULL;
...
CREATE INDEX track_mbid_idx_created ON track_mbid (created);
CREATE INDEX track_mbid_idx_updated ON track_mbid (updated) WHERE updated IS NOT NULL;
